...
void setup() {
  ...
  #ifdef STRING_FULL_DISTRIBUTION_DATE
    SERIAL_ECHO_MSG(
      " Last Updated: " STRING_FULL_DISTRIBUTION_DATE
      " | Author: " STRING_CONFIG_H_AUTHOR
    );
  #endif
  SERIAL_ECHO_MSG(" Compiled: " STRING_FULL_DISTRIBUTION_DATE);
