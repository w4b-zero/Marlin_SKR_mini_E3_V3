  ...
  */
  ...
  switch (parser.command_letter) {
    ...
    case 'M': switch (parser.codenum) {
      ...
      // M9000-M9004: Define/execute G-code music macro
      #if ENABLED(GCODE_MUSIC)
        case 9000: case 9001: case 9002: case 9003: case 9004:
        M9000_9004(); break;                                        // M9000-M9004: Define/execute G-code music macro
      #endif

      // M9005-M9009: Define/execute G-code music macro
      #if ENABLED(CUSTOM_GCODE_MUSIC)
        case 9005: case 9006: case 9007: case 9008: case 9009:
        M9005_9009(); break;                                        // M9005-M9009: Define/execute G-code music macro
      #endif
