...
//  {}
  ...
  LEDColor() : r(0), g(76), b(0)
    OPTARG(HAS_WHITE_LED, w(0))
    OPTARG(NEOPIXEL_LED, i(NEOPIXEL_BRIGHTNESS))
  {}
...
#define LEDColorDarkGreen()       LEDColor(  0,  20,   0)
...
public:
  ...
  static void set_bright_green() { set_color(LEDColorDarkGreen()); }
  static void set_white() { set_color(LEDColorWhite()); }
    ...
    static void show_rainbow() { Marlin_NeoPixel::rainbow(5);}
  #endif
