...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 133*60, 133*60, 40*60, 10*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define SHOW_BOOTSCREEN                 // Show the Marlin bootscreen on startup. ** ENABLE FOR PRODUCTION **
    ...
    #define BOOTSCREEN_TIMEOUT 250       // (ms) Total Duration to display the boot screen(s)
      ...
      #define CUSTOM_BOOTSCREEN_ANIMATED // Animated CUSTOM_BOOTSCREEN
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define EVENT_GCODE_SD_ABORT "G28XY\nG92 E0"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT          3600  // (seconds) Time limit before the nozzle is turned off for safety.
 ...
 *     M150 R255 U80 B0 I9 \n \
 *     G4 S1 \n \
 *     M150 R255 U80 B0 P80"
 *
 */
#define STARTUP_COMMANDS "M150 R255 U80 B0 U80"
 ...
 * G-code Music
 *
 * Add G-codes M9000-M9009 to define and run G-code music.
 * Macros are not saved to EEPROM.
 * Define Music in File Marlin/src/gcode/music/M9000-M9009.cpp
 * 
 * M9000 = scooter
 * M9001 = startrek
 * M9002 = starwars
...
#define CUSTOM_GCODE_MUSIC

#if ENABLED(CUSTOM_GCODE_MUSIC)
  #define CUSTOM_GCODE_MUSIC_SLOTS       5  // Up to 10 may be used
  #define CUSTOM_GCODE_MUSIC_SLOT_SIZE  50  // Maximum length of a single macro
#endif
