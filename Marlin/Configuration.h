...
#define STRING_CONFIG_H_AUTHOR "zeroTM (https://github.com/w4b-zero)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "AM8 SKR mini E3"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "Anet-AM8-0000-BTT-SKR-mini-E3-V3"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 154.50
  #define DEFAULT_bedKi 30.43
  #define DEFAULT_bedKd 523.20
...
//  #define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 10, 50 } // ...or, set your own edit limits
  #define MAX_FEEDRATE_EDIT_VALUES    { 3000, 3000, 100, 100 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
//#define NOZZLE_TO_PROBE_OFFSET { -34, 0, -2.43 }
#define NOZZLE_TO_PROBE_OFFSET { -34, 0, -2.73 }
 ...
 */
#define EVENT_GCODE_AFTER_G29 "G1 Z20 F12000\nG1 X0 Y215"
...
#define HOMING_FEEDRATE_MM_M { (133*60), (133*60), (40*60) }
...
#define SKEW_CORRECTION
  ...
  #define XY_DIAG_BD 142.0
  #define XY_SIDE_AD 100.1
...
//
#define PREHEAT_1_LABEL       "PLA(190)"
#define PREHEAT_1_TEMP_HOTEND 190
#define PREHEAT_1_TEMP_BED     70
#define PREHEAT_1_TEMP_CHAMBER 35
#define PREHEAT_1_FAN_SPEED   0 // Value from 0 to 255

#define PREHEAT_2_LABEL       "PLA(200)"
#define PREHEAT_2_TEMP_HOTEND 200
#define PREHEAT_2_TEMP_BED    70
#define PREHEAT_2_TEMP_CHAMBER 35
#define PREHEAT_2_FAN_SPEED   0 // Value from 0 to 255

#define PREHEAT_3_LABEL       "PLA(210)"
...
//#define STARTUP_TUNE { 1567, 206, 1567, 206, 1396, 103, 1318, 103, 1396, 413, 1174, 310, 1046, 103, 1174, 206, 1567, 206, 1567, 206, 1396, 206, 1318, 206, 1567, 206, 1567, 206, 1396, 103, 1318, 103, 1396, 413, 1174, 413, 1318, 206, 1046, 206, 1174, 827, 0, 206 }
...
#define NEOPIXEL_LED
  ...
  //#define NEOPIXEL_STARTUP_TEST         // Rainbow colors at startup
 ...
 *
 *  - Gradually change from green to orange as the heated bed gets to target temp
 *  - Gradually change from orange to red as the hotend gets to temperature
 *  - Change to 76 green to illuminate work surface
 *  - Change to 255 green once print has finished
